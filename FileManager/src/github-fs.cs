...
namespace FileManager
{
    public class FileSystem
    {
        ...
        {
            /*
             * To create a directory, you need to do x things:
             *  1. Create the corresponding directory table
             *  2. Encode the directory table into bytes
             *  3. write those bytes into a block 
             */
            return;
        }
